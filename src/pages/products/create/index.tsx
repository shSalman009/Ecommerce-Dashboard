...
function CreateProductForm() {
  ...
  const [createProduct, { data, error, isError, isLoading, isSuccess }] =
    ...
    <FormProvider {...form}>
      <Form {...form}>
        ...
        >
          ...
          <div className="sticky p-4 bottom-0 mt-6 bg-gray-100 dark:bg-gray-900 flex justify-end items-center rounded">
